...
import eci.edu.dosw.proyecto.exception.GlobalExceptionHandler;
import eci.edu.dosw.proyecto.service.impl.StudentServiceImpl;
...
class StudentControllerTest {
    ...
    void shouldCreateStudentSuccessfully() throws Exception {
        ...
        createDTO.setPhoneNumber("123456789"); // obligatorio
        createDTO.setAddress("Calle Falsa 123"); // obligatorio
        createDTO.setStatus("BLUE"); // obligatorio
    ...
    void shouldReturnBadRequestForNonStudentRolePatch() throws Exception {
        ...
        mockMvc.perform(patch("/api/students/A001")
                ...
                .andExpect(jsonPath("$.message").value("Solo los estudiantes pueden actualizar sus datos personales."));
    }
